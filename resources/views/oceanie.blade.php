...
<section id="slider">
  ...
  <label for="s1" class="slide" id="slide1">
    <div class="image"><img src="images/sydney.png" alt=""></div>
    <div class="descr">
  ...
  <div class="image"><img src="images/ville.jpg" alt=""></div>
    <div class="descr">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus nobis fuga, vitae numquam quidem ut deserunt id expedita maiores temporibus hic deleniti porro quas aut et quia perferendis alias? Eveniet.</p>
    </div>
  </label>
  <label for="s3" class="slide" id="slide3">
  <div class="image"><img src="images/sandiego.png" alt=""></div>
    <div class="descr">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus nobis fuga, vitae numquam quidem ut deserunt id expedita maiores temporibus hic deleniti porro quas aut et quia perferendis alias? Eveniet.</p>
    </div>
  </label>
  <label for="s4" class="slide" id="slide4">
  <div class="image"><img src="images/dubai.png" alt=""></div>
    <div class="descr">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus nobis fuga, vitae numquam quidem ut deserunt id expedita maiores temporibus hic deleniti porro quas aut et quia perferendis alias? Eveniet.</p>
    </div>
  </label>
  <label for="s5" class="slide" id="slide5">
  <div class="image"><img src="images/machuPichu.png" alt=""></div>
    <div class="descr">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus nobis fuga, vitae numquam quidem ut deserunt id expedita maiores temporibus hic deleniti porro quas aut et quia perferendis alias? Eveniet.</p>
    </div>
  </label>
